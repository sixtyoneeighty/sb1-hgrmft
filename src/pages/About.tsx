  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="We're not your typical tech consultants - and we're pretty proud of that. Learn about our unique approach to AI solutions." />
        <meta property="og:title" content="About Us | sixtyoneeighty" />
        <meta property="og:description" content="We're not your typical tech consultants - and we're pretty proud of that. Learn about our unique approach to AI solutions." />
